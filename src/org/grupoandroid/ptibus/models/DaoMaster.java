...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        DiaSemanaDao.createTable(db, ifNotExists);
        HorarioDao.createTable(db, ifNotExists);
        LinhaDao.createTable(db, ifNotExists);
        RotaDao.createTable(db, ifNotExists);
        horario_diaSemanaDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        DiaSemanaDao.dropTable(db, ifExists);
        HorarioDao.dropTable(db, ifExists);
        LinhaDao.dropTable(db, ifExists);
        RotaDao.dropTable(db, ifExists);
        horario_diaSemanaDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(DiaSemanaDao.class);
        registerDaoClass(HorarioDao.class);
        registerDaoClass(LinhaDao.class);
        registerDaoClass(RotaDao.class);
        registerDaoClass(horario_diaSemanaDao.class);
    }
